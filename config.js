...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~flh2URCC#ETL2Nu4waPhcnmBEItFYWyu5w3CAXOzGezw4rOVCrVE",  // HM5LNEYD
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50946062382",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("HD") || "",           // Owner's name
    ...
    REJECT_MSG: process.env.REJECT_MSG || "*📞 sorry to didnt respond to you pls call mh again 📵*",
